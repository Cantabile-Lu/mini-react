(function (global, factory) {
	...
	class FiberRootNode {
	    container;
	    current;
	    finishedWork; // 更新完成的hostRootFiber
	...
	// 消费update
	const processUpdateQueue = (baseState, // 初始update
	pendingUpdate) => {
	    const result = {
	...
	function childReconciler(shoulderTrackEffects) {
	...
	const internal = React__namespace.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
